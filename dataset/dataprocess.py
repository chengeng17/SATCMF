...
def create_graph_data(smiles: str, metal: str, metal_valence: int, logP_SA_cycle_normalized: float, explicit_H=False) -> dict:
    ...
    for atom in mol.GetAtoms():
        ...
        # if symbol == 'O' and atom.GetTotalNumHs() == 0 and 1.0 in bond_order and 'C' in neighbors:
        if symbol == 'O' and 1.0 in bond_order and 'C' in neighbors:
            metal_edge.append(atom.GetIdx())

        # if symbol == 'O' and atom.GetTotalNumHs() == 0 and 1.0 in bond_order and 'P' in neighbors:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_fold_dir", type=str, default = "'./10_fold_cv'", help="Directory where the processed data will be saved.")
